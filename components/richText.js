...
var GRT = [
	...
	// table
	['table', "width:98%; border-collapse: collapse;border:1px solid #F2F3F4"],
	['th', "font-size: 10px;border-right:1px solid #F2F3F4; border-bottom:1px solid #F2F3F4;padding: 2px;"],
	['td', "font-size: 10px;border-right:1px solid #F2F3F4; border-bottom:1px solid #F2F3F4;padding: 2px;"]
];
